...
LAB_SRC_DIR="labs_v2"                   # Labs v2 directory as the only source
DATA_SRC_DIR="data/class_data"
ROOT_CONFIG_FILE="jupyter_lite_config.json" # Explicit root config file

# --- Script Start ---
echo "Starting JupyterLite build process using labs_v2 content only..."
...
# 3. Process and copy labs_v2 notebooks to staging area
...
echo "- Processed labs_v2 notebooks with cross-compatibility at root level"
